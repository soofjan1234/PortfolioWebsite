...
const Projects = () => {
    ...
    return (
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-700 min-h-screen">
            ...
            {selectedProject && (
                <div
                    className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4 md:p-8 animate-in fade-in duration-300"
                    onClick={() => {
                ...
                >
                    <div
                        className="bg-white rounded-[2rem] shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto animate-in zoom-in-95 duration-300"
                    ...
                    >
                        ...
                        <div className="relative bg-gray-100">
                            <img
                                ...
                                className="w-full aspect-video object-cover rounded-t-[2rem]"
                            />
                            <button
                                onClick={() => {
                                    setSelectedProject(null)
