...
1. 通常情况下，Directory指向Table数组，表的长度就是2的GlobalDepth次方。比如Depth为2，长度就是4，我们就用高位的前两位来定位在哪个Table，比如01 10，当然可能多个条目指向一个Table。
...
[https://tonybai.com/2024/11/14/go-map-use-swiss-table/](https://tonybai.com/2024/11/14/go-map-use-swiss-table/)

[http://draven.co/golang/docs/part2-foundation/ch03-datastructure/golang-hashmap/#访问](http://draven.co/golang/docs/part2-foundation/ch03-datastructure/golang-hashmap/#%E8%AE%BF%E9%97%AE)